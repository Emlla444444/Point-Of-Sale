...
@section('content')
    <div class="container">
        ...
        <span><i class="fa-solid fa-user-tie"></i> admins - {{ count($accounts) }}</span>
        <div class="row">
            <div class="col">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($item->role == 'superadmin')
                                        <span
                                            class="btn btn-sm bg-warning text-white rounded shadow-sm">{{ $item->role }}</span>
                                    @elseif ($item->role == 'admin')
                                        <span
                                            class="btn btn-sm bg-secondary text-white rounded shadow-sm">{{ $item->role }}</span>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('profile#adminAccDetail',$item->id) }}" class="btn btn-sm btn-outline-primary"> <i class="fa-solid fa-circle-info"></i>
                                    </a>
                                </td>
                                <td>
                                    @if ($item->role != 'superadmin')
