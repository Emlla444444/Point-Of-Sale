                ...
                <div class="row">
                    <div class="col-3">
                        ...
                        <img class="img-profile img-thumbnail" id="output"
                            src="{{ asset($data[0]->profile == null ? 'default_image/defaultProfile.jpg' : 'profileImage/' . $data[0]->profile) }}">
                    ...
                    <div class="col">
                        ...
                        <div class="mt-2">
                            <a href="{{ route('profile#accountList', ['accountType' => 'admin']) }}" class="btn btn-sm btn-primary">Back</a>
                        </div>
                    </div>
                </div>
            </div>
