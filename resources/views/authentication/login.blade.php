                            ...
                            <div class="col-lg-8 offset-2">
                                <div class="p-5">
                                    ...
                                    @csrf
                                        ...
                                        <hr>
                                        <a href="{{ route('social#redirect','google') }}" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Login with Google
                                        </a>
                                        <a href="{{ route('social#redirect','github') }}" class="btn btn-facebook btn-user bg-dark btn-block">
