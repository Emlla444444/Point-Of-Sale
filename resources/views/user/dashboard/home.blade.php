                    ...
                    <div class="col-lg-8 text-end">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            ...
                            @foreach ($categories as $item)
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill @if (request('categoryId') == $item->id) active @endif"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form action="{{ route('user#home') }}" method="get">
                                            ...
                                            <select name="sortingType" class="form-select w-100 bg-white mt-3">
                                                <option value="">Sorting Types</option>
                                                ...
                                                <option value="nameDesc" @if (request('sortingType') == 'nameDesc') selected @endif>
                                                    Name(Z to A)</option>
                                                <option value="priceDesc" @if (request('sortingType') == 'priceAsc') selected @endif>
                                                    Price(Highest to Lowest)</option>
                                                <option value="priceAsc" @if (request('sortingType') == 'priceDesc') selected @endif>
                                                    Price(Lowest to Highest)</option>
                                                <option value="timeAsc" @if (request('sortingType') == 'timeAsc') selected @endif>
                                                    Time(Latest to Oldest)</option>
                                                <option value="timeDesc" @if (request('sortingType') == 'timeDesc') selected @endif>
                                                    Time(Oldest to Latest)</option>
                                            </select>
                                    ...
                                    @else
                                        <div class="row">
                                            <div class="col-6 offset-3">
                                                <img src="{{ asset('default_image/no-item-found-here.png') }}"
                                                    class=" w-100">
                                            </div>
                                        </div>
                                    @endif
