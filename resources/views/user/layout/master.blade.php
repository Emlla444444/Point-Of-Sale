...
<head>
    ...
    <!-- the 2 lines below is needed for contact template-->
    <link href="{{ asset('contact_template/css/fcf.default.css') }}" rel="stylesheet">
    <link href="{{ asset('contact_template/css/fcf.default-custom.css') }}" rel="stylesheet">
...
<body>
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="index.html" class="navbar-brand">
                    <h5 class="text-primary display-6"><i class="fa-brands fa-opensuse"></i>Loop <span
                            class=" text-warning">(POS_Web)</span></h5>
                </a>
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a href="{{ route('user#orderListPage') }}" class="nav-item nav-link">My Order</a>
                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle my-auto mt-2" data-bs-toggle="dropdown">
                                <img src="{{ asset(auth()->user()->profile == null ? 'default_image/defaultProfile.jpg' : 'userProfile/' . auth()->user()->profile) }}"
                                    style="width: 50px" class="img-profile  rounded-circle" alt="">
                                <span>{{ auth()->user()->name }}</span>
                            </a>
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                <a href="{{ route('user#profile') }}" class="dropdown-item my-2">Edit Profile</a>
                                <a href="{{ route('user#password') }}" class="dropdown-item my-2">Change Password</a>
        ...
        <div class="container py-5">
            <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
                            <h1 class="text-primary mb-0">Loop</h1>
                            <p class="text-secondary mb-0">point of sale</p>
                        </a>
                    </div>
                    <div class="col-lg-6">
    ...
    <!-- the 3 lines are needed for contact template-->
    <script src="{{ asset('contact_template/js/lang/fcf.en.js') }}"></script>
    <script src="{{ asset('contact_template/js/fcf.just-validate.min.js') }}"></script>
    <script src="{{ asset('contact_template/js/fcf.form.js') }}"></script>
