                            ...
                            <div class="tab-content mb-5">
                                ...
                                <div class="tab-pane" id="nav-mission" role="tabpanel"
                                    ...
                                    @foreach ($comments as $item)
                                        <div class="d-flex">
                                            <img src="{{ asset($item->profile == null ? 'default_image/defaultProfile.jpg' : 'userProfile/' . $item->profile) }}"
                                            ...
                                            <div class="">
                                                ...
                                                @if (auth()->user()->id == $item->user_id)
                                                    <span class="btn btn-outline-danger btn-sm rounded px-2"
                                                        onclick="deleteComment({{ $item->comment_id }})"><i
                ...
                <div class="owl-carousel vegetable-carousel justify-content-center">
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                            <img src="#" style="height: 250px" class="img-fluid w-100 rounded-top"
                                alt="">
                        </div>
